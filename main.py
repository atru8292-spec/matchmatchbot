...
async def lifespan(app: FastAPI):
    ...
    # 7.0 даёт больше шанса собрать раздражённую серию коротких сообщений в один залп; 20.0
    # max_wait — соразмерный потолок, чтобы не ждать вечно при действительно долгой печати.
    debouncer = Debouncer(_process_burst, delay=7.0, max_wait=20.0)
