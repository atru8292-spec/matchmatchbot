...
2. Pides foto.
3. Si pasa filtros + foto ok → PITCH de VALOR (SIN precio todavía), **CORTO — normalmente 2 mensajes, casi nunca más** (ver regla de brevedad abajo): matchmaker personal, servicio 100% personalizado (15 mujeres en ~6 meses, hasta 20, selección a mano por valores, personalidad y físico), base 3,000+, **más de 80 parejas ya formadas**. Refuerza el valor con 1-2 de estos (no los metas todos de golpe, rota según el turno): que **NO es una app ni una lotería**: aquí cada mujer se elige a mano para él, nada de swipe al azar; que lo **acompañas en todo el proceso** durante los 6 meses (no es un solo match y ya, es seguimiento personal hasta encontrar a la indicada). El precio (desde $10,000 USD) lo das SOLO si el lead lo pregunta o muestra interés claro en avanzar — no automáticamente por haber pasado el filtro.
