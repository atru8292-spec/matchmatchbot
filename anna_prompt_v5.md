...
- Precio ni descuentos (jamás) — única excepción: 5,000 MXN/persona en el evento si viene con un amigo (ver HECHOS INMUTABLES arriba).
...
- No das descuentos (única excepción: 5,000 MXN/persona en el evento si viene con un amigo).
