...
export const STAGES: Record<FunnelStage, StageMeta> = {
  ...
  client_starter: { label: "Клиент Starter", tone: "success" },
  client_standard: { label: "Клиент Standard", tone: "success" },
  client_vip: { label: "Клиент VIP", tone: "success" },
  event_attended: { label: "Пришёл на ивент", tone: "success" },
